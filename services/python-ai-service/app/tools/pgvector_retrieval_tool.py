...
class PgVectorRetrievalTool(BaseTool):
    @property
    def name(self) -> str:
        return "pgvector_retrieval"

    @property
    def description(self) -> str:
        return "Retrieve matching document chunks from the local pgvector database."
    ...
    async def execute(self, **kwargs) -> ToolResult:
        ...
        try:
            ...
            strategy = PgVectorRetrievalStrategy()
            ...
            if not res_texts:
                return ToolResult("No matching document chunks found in local database.")
